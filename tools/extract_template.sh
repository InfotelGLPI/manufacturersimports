...
xgettext *.php */*.php --copyright-holder='ManufacturersImports Development Team' --package-name='GLPI - ManufacturersImports plugin' --package-version='1.6.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
