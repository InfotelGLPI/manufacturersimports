...
INSERT INTO `glpi_plugin_manufacturersimports_configs` ( `ID`,`name`,`entities_id`,`is_recursive`, `supplier_url` , `manufacturers_id`, `suppliers_id`, `warranty_duration`, `document_adding`, `documentcategories_id`) VALUES ('2','HP',0,0,'http://h20000.www2.hp.com/bizsupport/TechSupport/WarrantyResults.jsp?', '0', '0','36', '0','0');
